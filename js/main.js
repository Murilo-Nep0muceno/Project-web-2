...
function changePage( event){
    ...
    if(errorEmail( ) && errorName && errorDate() && errorGender() && errorMenssage() && errorSelect && errorTel() ){
...
function errorMenssage(){
    ...
    if(!form.form_menssage().value){
        return false
    }
    return true
}

function menssageIsValis(){
    form.error_menssage().style.display = errorMenssage() ? "none" :  "block"
}
...
const form ={
    ...
    form_menssage: () => document.getElementById("form_menssage"),
    error_menssage: () => document.getElementById("error_menssage"),
